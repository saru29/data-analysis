...
# of exercise data; or 43,500 seconds. Once the 5 minute internal data set tests are completed, a small attempt
...
# ---------------
# data sets
df_1 = pd.read_csv("s_131.csv", index_col='step')
df_2 = pd.read_csv("s_131.csv", index_col='step')
...
Multi_linear_regression_model(df_1, df_2)
